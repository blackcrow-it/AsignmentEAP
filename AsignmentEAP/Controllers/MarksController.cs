...
namespace AsignmentEAP.Controllers
{
    public class MarksController : Controller
    {
        ...
        public MarksController(AsignmentEAPContext context)
        {
            _context = context;
        }
        ...
        {
            var asignmentEAPContext = _context.Mark.Include(m => m.Subject);
        ...
        {
            ViewData["Id"] = new SelectList(_context.Set<Subject>(), "Id", "Id");
            return View();
        }
